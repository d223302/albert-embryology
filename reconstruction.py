...
for i, line in tqdm(enumerate(text_file.readlines())):
  ...
  for span in data['targets']:
    ...
    predict = prediction_scores[span['span1'][0]: span['span1'][1]]
    ground_truth = indexed_tokens[span['span1'][0]: span['span1'][1]]
...
with open('/home/dcml0714/albert_embryo/exp_result/pretrain/reconstruction.txt', 'a+') as f:
  f.write(result + '\n')  
"""
